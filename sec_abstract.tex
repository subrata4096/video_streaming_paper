...
For this project, we shall characterize the power efficiency of mobile video streaming services over 4G/3G/Wi-Fi.
We shall evaluate the energy efficieny of various streaming applications like \textit{YouTube}, \textit{Netflix} and \textit{hulu} and aim to identify power wastage in the existing approach. We shall collect packet traces for these streaming applications and pinpoint source of wasteful data and power drains with the help of ARO\cite{qian2011demo}, a widely accepted tool developed by AT\&T researchers for power modeling.     
\end{abstract}
